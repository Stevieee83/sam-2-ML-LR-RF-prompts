...
parser.add_argument("--sam2_checkpoint", type=str, default='C:/model_weights/sam-2/sam2_hiera_large.pt')
parser.add_argument("--model_cfg", type=str, default='C:/Users/r02sw23/PycharmProjects/pythonProject1/.venv/PANet-master-borebreen-sam2/sam2_configs/sam2_hiera_l.yaml')
parser.add_argument("--model_name", type=str, default='ViT-large')
...
def main():
    ...
    path = f'./results/multi_mask_single_point/{args.model_name}/borebreen_image_{str(args.file_number)}_1BG_1FG/'  # Creates the file path for the output results
    ...
    output_path = f'./results/multi_mask_single_point/{args.model_name}/image_{str(args.file_number)}/output_masks/'  # Output filepath directory for the segmentation mask results
    ...
    mask_input = cv2.imread(voc_mask_path, 0)
    ...
    masks, scores, logits = predictor.predict(
        point_coords=None,
        point_labels=None,
        mask_input=mask_input_reshaped,
